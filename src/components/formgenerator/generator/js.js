    ...
    file: confGlobal.formBtns
      ? {
        ...
        resetForm: `resetForm() {
          ...
          xhr.setRequestHeader("x-token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVVUlEIjoiY2I4NDY2ZTAtYjU2Yy00NzI3LWI3YmUtMTY4MGRjMjg2MjMyIiwiSUQiOjEsIlVzZXJuYW1lIjoiYWRtaW4iLCJCdWZmZXJUaW1lIjo4NjQwMCwiQXV0aG9yaXR5SWQiOjEsImV4cCI6MTY1MjM1ODM2NywiaXNzIjoiZ3NkUGx1cyIsIm5iZiI6MTY1MTc1MjU2N30._e_odH9FOYd-ojn4VSO600mAfDUHauYosXSf3GW5Wh4"); // 设置请求头
          xhr.send( // 设置需要携带到后端的字段，字符串形式
          JSON.stringify({
            "appId": 49,
            "form": { "fields": [ { "__config__": { "label": "单行文本", "labelWidth": null, "showLabel": true, "changeTag": true, "tag": "el-input", "tagIcon": "input", "required": true, "layout": "colFormItem", "span": 24, "document": "https://element.eleme.cn/#/zh-CN/component/input", "regList": [], "typeNumber": 0, "formId": 101, "renderKey": "1011652181683567", "defaultValue": "我是单行文本" }, "__slot__": { "prepend": "", "append": "" }, "placeholder": "请输入单行文本", "style": { "width": "100%" }, "clearable": true, "prefix-icon": "", "suffix-icon": "", "maxlength": null, "show-word-limit": false, "readonly": false, "disabled": false, "__vModel__": "field101", "options": [ { "id": 1, "value": 1, "label": "选项1", "children": [ { "id": 2, "value": 2, "label": "选项1-1" } ] } ] } ], "formRef": "elForm", "formModel": "formData", "size": "medium", "labelPosition": "right", "labelWidth": 100, "formRules": "rules", "gutter": 15, "disabled": false, "span": 24, "formBtns": true }
...
// const files = require.context('@/api/formGenerator', true,)
